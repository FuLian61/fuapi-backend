...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        // 判断该接口是否可以调用
        com.yupi.fuapiclientsdk.model.User user = new com.yupi.fuapiclientsdk.model.User();
        user.setUserName("test");
        String userName = fuApiClient.getUserNameByPost(user);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest ,
        ...
        FuApiClient tempClient = new FuApiClient(accessKey, secretKey);
        Gson gson = new Gson();
        com.yupi.fuapiclientsdk.model.User user = gson.fromJson(userRequestParams, com.yupi.fuapiclientsdk.model.User.class);
